/**
 * Borrowed from https://github.com/metaplex-foundation/kinobi/blob/main/src/shared/logs.ts
 * Original code by @lorisleiva with minor alterations
 * Pending license: https://github.com/metaplex-foundation/kinobi/issues/103
 */
