...
void UWalletCreationWidget::NativeConstruct()
{
	...
	HomeWidget->CreateNewWalletButton->OnClicked.AddUniqueDynamic(
		this, &UWalletCreationWidget::OnCreateNewWalletButtonClicked);
	HomeWidget->UseSecretRecoveryPhrase->OnClicked.AddUniqueDynamic(
		this, &UWalletCreationWidget::OnUseSecretRecoveryPhraseButtonClicked);
}

void UWalletCreationWidget::NativeDestruct()
{
	HomeWidget->CreateNewWalletButton->OnClicked.RemoveDynamic(
		this, &UWalletCreationWidget::OnCreateNewWalletButtonClicked);
	HomeWidget->UseSecretRecoveryPhrase->OnClicked.RemoveDynamic(
		this, &UWalletCreationWidget::OnUseSecretRecoveryPhraseButtonClicked);
...
void UWalletCreationWidget::OnCreateNewWalletButtonClicked()
{
	...
	GenerateSecretRecoveryPhraseWidget->ContinueButton->OnClicked.AddUniqueDynamic(
		this, &UWalletCreationWidget::OnUserSavedMnemonic);
}
...
void UWalletCreationWidget::OnUseSecretRecoveryPhraseButtonClicked()
{
	...
	UseSecretRecoveryPhraseWidget->OnMnemonicSubmitted.AddUniqueDynamic(
		this, &UWalletCreationWidget::OnMnemonicSubmitted);
}
...
void UWalletCreationWidget::OnMnemonicSubmitted(const FString& Mnemonic)
{
	if (SolanaWallet->IsMnemonicValid(Mnemonic))
	{
		...
		UseSecretRecoveryPhraseWidget->OnMnemonicSubmitted.RemoveDynamic(
			this, &UWalletCreationWidget::OnMnemonicSubmitted);
		Switcher->SetActiveWidget(SelectDerivationPath);
		SelectDerivationPath->OnDerivationPathSelected.AddUniqueDynamic(
			this, &UWalletCreationWidget::OnDerivationPathSelected);
	}
}

void UWalletCreationWidget::OnDerivationPathSelected(const FDerivationPath& Path)
{
	SelectDerivationPath->OnDerivationPathSelected.
	                      RemoveDynamic(this, &UWalletCreationWidget::OnDerivationPathSelected);
