...
struct FOUNDATION_API FAccount
{
	...
	UPROPERTY(SaveGame, NotBlueprintable)
	...
	static FString GetShortDisplayablePublicKey(const FString& PublicKey, int32 InitialCharsCount = 6,
	                                            int32 FinalCharsCount = 4);
};
